...
**Still upstream:** `cargo-ai orchestration action cost-table` generates the header *"The other 337 actions … cost no credits"*. True of provider price, false of anything that runs in a workflow, and unfixable from this repo — the generator lives in the CLI.
