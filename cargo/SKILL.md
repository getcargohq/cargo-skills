...
**Skills that carry a CDK example:** ~20 pre-written GTM outcomes (TAM building,
...
keep arriving. Each such skill is a self-contained worked example the installing agent
